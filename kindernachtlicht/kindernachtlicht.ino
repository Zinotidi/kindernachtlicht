...
<main>
  ...
  <section>
    <p>Diese lampe soll Ole erm&ouml;glichen zu erkennen, ob es Zeit zum schlafen oder Zeit zum aufstehen ist.<br /><a href="#hinweise">Hier</a> gibt es weitere Hinweise.</p>  
  </section>
